...
if($conn->connect_error){
  ...
  $sql0= "select * from menbannerdata"; 
...
<nav class="navbar navbar-expand-lg navbar-light header">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link fa-bounce" href="mens.php" style="border-bottom: 1px solid; black;">MEN'S</a>
      </li>
      <li class="nav-item active">
...
<div class="row">
<div class="col-xl-12">
  <h1 class="h1 fa-bounce"><center>MEN'S</center></h1>
</div>
</div>
</div>
<br><br>
