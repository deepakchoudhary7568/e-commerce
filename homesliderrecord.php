...
if($conn->connect_error){
  ...
  $sql = "select * from homesliderdata"; 
...
<td><button class="btn btn-info"><a href="homeslideredit.php?id=<?php echo $rows['id'];?>">Edit</a></button>

<button class="btn btn-success"><a href="homesliderview.php?id=<?php echo $rows['id'];?>">view</a></button>

<button class="btn btn-danger"><a href="homesliderdelete.php?id=<?php echo $rows['id'];?>">delete</a></button></td>
