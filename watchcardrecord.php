...
<td><button class="btn btn-info"><a href="watccardredit.php?id=<?php echo $rows['id'];?>">Edit</a></button>

<button class="btn btn-success"><a href="watchcardview.php?id=<?php echo $rows['id'];?>">view</a></button>

<button class="btn btn-danger"><a href="watchcarddelete.php?id=<?php echo $rows['id'];?>">delete</a></button></td>
