    ...
    <table> 
        ...
        <tbody> 
            ...
            <tr> 
                ...
                <td><img src="image/<?php echo $rows['image']; ?>" height="50px"></td> 
                <td><?php echo $rows['phonename']; ?></td>
                <td><?php echo $rows['price']; ?></td> 
                <td><button class="btn btn-info"><a href="homecard2edit.php?id=<?php echo $rows['id']; ?>">Edit</a> </button>
                    <button class="btn btn-primary"><a href="homecard2view.php?id=<?php echo $rows['id']; ?>">View</a> </button> 
                  <button class="btn btn-danger"><a href="homecard2delete.php?id=<?php echo $rows['id']; ?>">Delete</a> </button> 
