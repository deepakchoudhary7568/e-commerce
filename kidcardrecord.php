...
<td><button class="btn btn-info"><a href="kidcardedit.php?id=<?php echo $rows['id'];?>">Edit</a></button>

<button class="btn btn-success"><a href="kidcardview.php?id=<?php echo $rows['id'];?>">view</a></button>

<button class="btn btn-danger"><a href="kidcarddelete.php?id=<?php echo $rows['id'];?>">delete</a></button></td>
