...
<nav class="navbar navbar-expand-lg navbar-light header">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link fa-bounce" href="contact.php" style="border-bottom: 1px solid; black;">CONTACT</a>
      </li>
    </ul>
  </div>
</nav><br><br>
...
<div class="row">
<div class="col-xl-12">
  <h1 class="h1 fa-bounce"><center>CONTACT</center></h1>
</div>
</div>
</div>
<br><br>
...
<div class="col-md-6">
  ...
  <p style="color: gray;">Lorem ipsum dolor sit amet, consectetur<br> adipiscing elit. Ut id leo tempor, congue justo at,<br> lobortis orci.</p><br>

  <a href="#" style="margin-left: 10px; text-decoration: none; color: black;"><i class="fa-solid fa-location-dot"></i><b  style="margin-left: 15px;">123 Fifth Avenue,  New York, NY 10160</b></a><br>

 <a href="#" style="margin-left: 10px; text-decoration: none; color: black;"><i class="fa-solid fa-envelope"></i><b  style="margin-left: 15px;"> contact@info.com</b></a><br>

 <a href="#" style="margin-left: 10px; text-decoration: none; color: black;"><i class="fa-solid fa-phone"></i><b  style="margin-left: 15px;" >9-334-7565-9787</b></a><br>
<br><br><br>

</div>
<div class="col-md-6" >
  <form action="contactforminsert.php" method="post" enctype="multipart/form-data"  >
    <label>Name</label><br>
    <input type="text"  name="name" style=" border-top: 3px solid  #00ff00; border-bottom: 3px solid #ff00ff; width: 100%;"><br><br>
    <label>Last</label><br>
    <input type="text"  name="lname" style=" border-top: 3px solid  #00ff00; border-bottom: 3px solid #ff00ff; width: 100%;"><br><br>
    <label>Gmail</label><br>
    <input type="email"  name="gmail" style=" border-top: 3px solid  #00ff00; border-bottom: 3px solid #ff00ff; width: 100%;"><br><br>
    <label>Message</label><br>
    <textarea name="message"  style=" border-bottom: 3px solid #ff00ff; width: 100%;"></textarea><br><br>
    <button class="btn btn-danger h1" style="font-size: 30px; filter: drop-shadow(1px 1px black);" >SEND</button>
