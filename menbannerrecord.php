...
<td><button class="btn btn-info"><a href="menbanneredit.php?id=<?php echo $rows['id'];?>">Edit</a></button>

<button class="btn btn-success"><a href="menbannerview.php?id=<?php echo $rows['id'];?>">view</a></button>

<button class="btn btn-danger"><a href="menbannerdelete.php?id=<?php echo $rows['id'];?>">delete</a></button></td>
