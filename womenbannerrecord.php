...
if($conn->connect_error){
  ...
  $sql = "select * from womenbannerdata"; 
...
<td><button class="btn btn-info"><a href="womenbanneredit.php?id=<?php echo $rows['id'];?>">Edit</a></button>

<button class="btn btn-success"><a href="womenbannerview.php?id=<?php echo $rows['id'];?>">view</a></button>

<button class="btn btn-danger"><a href="womenbannerdelete.php?id=<?php echo $rows['id'];?>">delete</a></button></td>
