...
<td><button class="btn btn-info"><a href="kidbanneredit.php?id=<?php echo $rows['id'];?>">Edit</a></button>

<button class="btn btn-success"><a href="kidbannerview.php?id=<?php echo $rows['id'];?>">view</a></button>

<button class="btn btn-danger"><a href="kidbannerdelete.php?id=<?php echo $rows['id'];?>">delete</a></button></td>
