...
<td><button class="btn btn-info"><a href="womencardedit.php?id=<?php echo $rows['id'];?>">Edit</a></button>

<button class="btn btn-success"><a href="womencardview.php?id=<?php echo $rows['id'];?>">view</a></button>

<button class="btn btn-danger"><a href="womencarddelete.php?id=<?php echo $rows['id'];?>">delete</a></button></td>
