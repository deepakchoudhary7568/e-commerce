...
<td> <img src="image/<?php echo $rows['image'];?>" height="100px" width="auto"> </td> 

<td><button class="btn btn-info"><a href="homecard1edit.php?id=<?php echo $rows['id'];?>">Edit</a></button>

<button class="btn btn-success"><a href="homecard1view.php?id=<?php echo $rows['id'];?>">view</a></button>

<button class="btn btn-danger"><a href="homecard1delete.php?id=<?php echo $rows['id'];?>">delete</a></button></td>
