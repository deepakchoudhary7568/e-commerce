...
if($conn->connect_error){
  ...
  $sql = "select * from watchbannerdata"; 
...
<td> <img src="image/<?php echo $rows['image'];?>" height="50px" width="auto"> </td> 

<td><button class="btn btn-info"><a href="watchbanneredit.php?id=<?php echo $rows['id'];?>">Edit</a></button>

<button class="btn btn-success"><a href="watchbannerview.php?id=<?php echo $rows['id'];?>">view</a></button>

<button class="btn btn-danger"><a href="watchbannerdelete.php?id=<?php echo $rows['id'];?>">delete</a></button></td>
