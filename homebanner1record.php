...
if($conn->connect_error){
  ...
  $sql = "select * from homebanner1data"; 
...
<td><button class="btn btn-info"><a href="homebanner1edit.php?id=<?php echo $rows['id'];?>">Edit</a></button>

<button class="btn btn-success"><a href="homebanner1view.php?id=<?php echo $rows['id'];?>">view</a></button>

<button class="btn btn-danger"><a href="homebanner1delete.php?id=<?php echo $rows['id'];?>">delete</a></button></td>
