    ...
    <table> 
        ...
        <tbody> 
            ...
            <tr> 
                ...
                <td><button class="btn btn-info"><a href="homecard3edit.php?id=<?php echo $rows['id']; ?>">Edit</a> </button>
                    <button class="btn btn-primary"><a href="homecard3view.php?id=<?php echo $rows['id']; ?>">View</a> </button> 
                  <button class="btn btn-danger"><a href="homecard3delete.php?id=<?php echo $rows['id']; ?>">Delete</a> </button> 
