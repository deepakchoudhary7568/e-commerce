...
<td><button class="btn btn-info"><a href="mencardedit.php?id=<?php echo $rows['id'];?>">Edit</a></button>

<button class="btn btn-success"><a href="mencardview.php?id=<?php echo $rows['id'];?>">view</a></button>

<button class="btn btn-danger"><a href="mencarddelete.php?id=<?php echo $rows['id'];?>">delete</a></button></td>
