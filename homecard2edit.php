...
$id=$_GET['id'];
  ...
  $sql = "select * from homecard2data where id=$id"; 
...
<main role="main">
  ...
  ?>
      ...
      <form action="homecard2editinsert.php" method="post" enctype="multipart/form-data">

        <input type="hidden" name="id" value="<?php echo $values['id']; ?>" />
          
         <div class="twothirds">
           Phone Name:<br/>
          <input type="text" name="phonename" value="<?php echo $values['phonename']; ?>" size="40"/><br/><br/>
           <div class="twothirds">
          Image:<br/>
          ...
          <img src="image/<?php echo $values['image'];?>" height="100px" width="auto"><br/>    

           price:<br/>
          <input type="text" name="price"  value="<?php echo $values['price']; ?>" size="40"/><br/><br/>
        </div>
